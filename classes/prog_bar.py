...
class ProgressBar(Window):
    def __init__(self):
        ...
        self.prog_bar_pos = {"x": self.prog_bar_props["pos"][0], "y": self.prog_bar_props["pos"][1]}
        self.prog_bar_scale = {"width": self.prog_bar_props["scale"][0], "height": self.prog_bar_props["scale"][1]}
